    ...
    const FileClock = () => (
        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
                ...
                strokeWidth={2}
                d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z M12 8v4l3 3"
            />
        </svg>
    );
        ...
        <div className="sidebar">
            ...
            <div className="sidebar-content">
                ...
                {reports.map((report) => {
                    ...
                    const status =
                        (stats.failed || stats.unexpected || 0) > 0
                            ? 'failed'
                            : (stats.flaky || 0) > 0
                              ? 'flaky'
                              : 'passed';
                    ...
                    <div className="sidebar-footer-info">
                        ...
                        <span className="sidebar-footer-value">
                            {(() => {
                                ...
                                const passed =
                                    activeReport.stats.passed || activeReport.stats.expected || 0;
                                const total =
                                    activeReport.stats.total ||
                                    passed +
                                        (activeReport.stats.failed ||
                                            activeReport.stats.unexpected ||
                                            0);
                        ...
                        <div
                            ...
                            style={{
                                width: (() => {
                                    ...
                                    if (!activeReport || !activeReport.stats) return '0%';
                                    const passed =
                                        activeReport.stats.passed ||
                                        activeReport.stats.expected ||
                                        0;
                                    const total =
                                        activeReport.stats.total ||
                                        passed +

...
const TestDetails = ({ spec }) => {
    ...
    const allErrors = [...(result.error ? [result.error] : []), ...(result.errors || [])];
                            ...
                            return (
                                <div key={idx} className="test-attachment-card">
                                    <div className="test-attachment-content">
                                        <div
                                            className={`test-attachment-icon ${
                                                isImage
                                                    ? 'test-attachment-icon-purple'
                                                    : isVideo
                                                      ? 'test-attachment-icon-blue'
                    ...
                    <div className="test-steps-list">
                        {result.steps.map((step, idx) => (
                            <div key={idx} className="test-step-item">
                                ...
                                <span className="test-step-duration">

    ...
    if (filteredSuites.length === 0) {
        return (
            <div className="suite-empty">
                <div className="suite-empty-icon">{/* <FileText /> */}</div>
                <h3 className="suite-empty-title">No tests match your filter</h3>
                <p className="suite-empty-text">
                ...
                >
                    <div className="suite-header">
                        <div className="suite-header-content">
                            <div className="suite-icon">{/* <FileText /> */}</div>
                            <div>
                                <h3 className="suite-title">{getFileName(suite.title)}</h3>

                    ...
                    <div className="main-inner">
                        ...
                        <div className="header-section">
                            ...
                            <div className="header-project">
                                <div className="header-project-card">
                                    ...
                                    <span className="header-project-value">
                        ...
                        <div className="kpi-grid">
                            ...
                            <StatCard
                                ...
                                icon={XCircle}
                                subtext={
                                    report.stats.unexpected > 0 ? 'Action Required' : 'All Clean'
                                }
                                delay={200}
                            />
                            <StatCard
                        ...
                        <div className="charts-grid">
                            ...
                            <div className="chart-card chart-card-double">
                                <h3 className="chart-title">
                                    ...
                                    Duration Insights{' '}
                                    <span className="chart-title-subtitle">(Top 5 Slowest)</span>
                                </h3>
                                <div className="chart-container">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <BarChart
                        ...
                        <div className="filter-bar">
                            <div className="filter-buttons">
                                ...
                                >
                                    Passed{' '}
                                    <span className="filter-badge filter-badge-passed">
                                ...
                                >
                                    Failed{' '}
                                    <span className="filter-badge filter-badge-failed">
                                ...
                                >
                                    Flaky{' '}
                                    <span className="filter-badge filter-badge-flaky">
                                        {report.stats.flaky}
                                    </span>
                                </button>
                            </div>
                        ...
                        <div className="footer">
                            <p className="footer-text">
                                Generated with{' '}
                                <span className="footer-version">v{report.config.version}</span> •{' '}
